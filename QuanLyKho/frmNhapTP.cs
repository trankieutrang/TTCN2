...
namespace QuanLyKho
{
    public partial class frmNhapTP : Form
    {
        public frmNhapTP()
        {
            InitializeComponent();
        ...
        private void frmNhapTP_Load(object sender, EventArgs e)
        {
            loadDataToGridView();
            Class.Functions.FillCombo("SELECT MaNV, HoTenNV FROM NhanVien", cboMaNV, "MaNV", "MaNV");
            cboMaNV.SelectedIndex = -1;
            Class.Functions.FillCombo("SELECT MaHang FROM HangHoa a join NhomHang b on a.MaNhomHang=b.MaNhomHang where b.MaNhomHang='NH02'", cboMaHang, "MaHang", "MaHang");
        ...
        private void loadDataToGridView()
        {
            ...
            sql = "select a.MaPhieuNK,a.MaNCC,a.MaNV,a.MaDonDatHang,b.MaHang," +
                ...
                " from PhieuNK a join ChiTietPhieuNK b on a.MaPhieuNK = b.MaPhieuNK join HangHoa on b.MaHang=HangHoa.MaHang join NhomHang on HangHoa.MaNhomHang = NhomHang.MaNhomHang where NhomHang.MaNhomHang='NH02'";
            tableHT = Class.Functions.GetDataToTable(sql);
            dataGridView_NhapTP.DataSource = tableHT;
            dataGridView_NhapTP.Columns[0].HeaderText = "Mã Phiếu";
            dataGridView_NhapTP.Columns[1].HeaderText = "Mã NCC";
            dataGridView_NhapTP.Columns[2].HeaderText = "Mã NV";
            dataGridView_NhapTP.Columns[3].HeaderText = "Mã ĐơnĐH";
            dataGridView_NhapTP.Columns[4].HeaderText = "Mã Hàng";
            dataGridView_NhapTP.Columns[5].HeaderText = "Ngày lập";
            dataGridView_NhapTP.Columns[6].HeaderText = "Số lượng";
            dataGridView_NhapTP.Columns[7].HeaderText = "Đơn Giá";
            dataGridView_NhapTP.Columns[8].HeaderText = "Tổng";
            dataGridView_NhapTP.Columns[9].HeaderText = "Tỉ lệ CK";
            dataGridView_NhapTP.Columns[10].HeaderText = "Chiết khấu";
            dataGridView_NhapTP.Columns[11].HeaderText = "Thành tiền";
            dataGridView_NhapTP.Columns[12].HeaderText = "Ghi chú";
            // Không cho phép thêm mới dữ liệu trực tiếp trên lưới
            dataGridView_NhapTP.AllowUserToAddRows = false;
            // Không cho phép sửa dữ liệu trực tiếp trên lưới
            dataGridView_NhapTP.EditMode = DataGridViewEditMode.EditProgrammatically;
        }

        private void dataGridView_NhapTP_Click(object sender, EventArgs e)
        {
            double tong;
            txtMaDon.Text = dataGridView_NhapTP.CurrentRow.Cells["MaPhieuNK"].Value.ToString();
            cboMaHang.Text = dataGridView_NhapTP.CurrentRow.Cells["MaHang"].Value.ToString();
            cboMaNV.Text = dataGridView_NhapTP.CurrentRow.Cells["MaNV"].Value.ToString();
            mskNgayLap.Text = dataGridView_NhapTP.CurrentRow.Cells["NgayLap"].Value.ToString();
            txtGhiChu.Text = dataGridView_NhapTP.CurrentRow.Cells["GhiChu"].Value.ToString();
            txtDonGia.Text = dataGridView_NhapTP.CurrentRow.Cells["DonGia"].Value.ToString();
            txtSoLuong.Text = dataGridView_NhapTP.CurrentRow.Cells["SoLuong"].Value.ToString();
            txtTong.Text = dataGridView_NhapTP.CurrentRow.Cells["Tong"].Value.ToString();
            cboMaNCC.Text = dataGridView_NhapTP.CurrentRow.Cells["MaNCC"].Value.ToString();
            cboMaDon.Text = dataGridView_NhapTP.CurrentRow.Cells["MaDonDatHang"].Value.ToString();
            txtTiLe.Text = dataGridView_NhapTP.CurrentRow.Cells["TyLeChietKhau"].Value.ToString();
            txtCK.Text = dataGridView_NhapTP.CurrentRow.Cells["ChietKhau"].Value.ToString();
            txtSoLuong.Text = dataGridView_NhapTP.CurrentRow.Cells["SoLuong"].Value.ToString();
            txtThanhTien.Text = dataGridView_NhapTP.CurrentRow.Cells["ThanhTien"].Value.ToString();
            txtTongtien.Text = dataGridView_NhapTP.CurrentRow.Cells["ThanhTien"].Value.ToString();
        ...
        {
            int count = 0;
            count = dataGridView_NhapTP.Rows.Count;
            string chuoi = "";
            int chuoi1 = 0;
            chuoi = Convert.ToString(dataGridView_NhapTP.Rows[count-1].Cells[0].Value);
